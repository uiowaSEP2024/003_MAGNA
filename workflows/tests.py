class TestViewWorkflows:
    ...
    def test_no_workflows_exist_in_database(self):
        """If no workflows exist in the database, the view should return an empty list of workflows."""
...
class TestEditWorkflow:
    """Tests for the edit_workflow view."""
...
class TestDeleteWorkflow:
    """Tests for the delete_workflow view."""

    #  Deletes a workflow when a POST request is received
    def test_delete_workflow_post_request(self):
        """The view should delete the workflow when a POST request is received."""
    ...
    def test_delete_workflow_invalid_pk(self):
        """The view should return a 404 error if the workflow with the given primary key does not exist."""
        # Create a mock request object with method set to POST
        request = type("Request", (object,), {"method": "POST"})
...
class TestManagerReview:
    """Tests for the manager_review view."""
    ...
    def test_retrieve_absence_request(self):
        """The function should retrieve the absence request object with the given primary key and 'submitted' workflow status."""
        # Arrange
        request = HttpRequest()
        request.method = "GET"
        pk = 1
        absence_request = AbsenceRequest.objects.create(
            pk=pk, workflow__status="submitted"
        )
    ...
    def test_absence_request_not_found(self):
        """If the absence request object with the given primary key does not exist, the function should raise a 404 error."""
        # Arrange
        request = HttpRequest()
        request.method = "GET"
        pk = 1
...
class TestHrReview:
    ...
    def test_renders_template_with_context(self):
        """The view should render the 'workflows/review.html' template with the 'absence_request' object as context."""
        # Arrange
        request = RequestFactory().get("/")
        absence_request = AbsenceRequest.objects.create(
            pk=1, workflow__status="manager_review"
        )
    ...
    def test_returns_404_if_absence_request_does_not_exist(self):
        """The view should return a 404 response if the 'AbsenceRequest' object with the given 'pk' does not exist."""
        # Arrange
        request = RequestFactory().get("/")
